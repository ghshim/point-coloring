...
def makeBEVMap(PointCloud_,Camera_,Calib_, boundary):
    ...
    sum_normalized_intensity = df.groupby(['grid_x', 'grid_y'])['normalized_z'].transform('sum')
    ...
    df['Zr+Ir'] = df['r'] * (densityMap[df['grid_x'], df['grid_y']] * df['normalized_intensity'] + (1-densityMap[df['grid_x'], df['grid_y']])*df['normalized_z'])
    df['Zg+Ig'] = df['g'] * (densityMap[df['grid_x'], df['grid_y']] * df['normalized_intensity'] + (1-densityMap[df['grid_x'], df['grid_y']])*df['normalized_z'])
    df['Zb+Ib'] = df['b'] * (densityMap[df['grid_x'], df['grid_y']] * df['normalized_intensity'] + (1-densityMap[df['grid_x'], df['grid_y']])*df['normalized_z'])
